...
// getDimenions takes the instance metadata and creates the cloudwatch
// dimension object.
// These dimensions are:
// - InstanceId, ImageId, InstanceType, FileSystem
...
// addMetrics adds a given metric to the array of metrics
...
// putMetric pushes the metric to AWS
